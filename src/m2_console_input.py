...
def double_a_float():
    ...
    n = float(input("Type in a floating point number: "))
    n = n * 2
    print(n)
...
def print_an_integer_many_times_on_one_row():
    ...
    s = ''
    x = int(input("How many times, part 2: "))
    for k in range(x):
        s = s + str(x * 2)
    print(s)
...
def input_it_all():
    ...
    n = float(input('Input a positive floating point: '))
    x = int(input('Input a positive integer, dude: '))
    s = input('Give me a string, yo: ')
